...
void Window::loadSprites()
{
	...
	font.loadFromFile("./assets/perfect_dark.ttf");

	s_text.setFont(font);
	s_text.setString("SOBAKON");
	...
	p_text.setFillColor(sf::Color::Cyan);
					...
					if (sf::Keyboard::isKeyPressed(sf::Keyboard::Return))
					{
						...
						if (pauseIndex == 1)
						{
							...
							case 1:
							{
								...
								list.deleteList();
								list.loadLevel("./assets/levels/level_1.txt");
								list.setX();
								list.setY();
								setting("Level 1", sf::Vector2u(list.cols * 40, list.rows * 40));
								nivelActual = 1;
							...
							{
								list.deleteList();
								list.loadLevel("./assets/levels/level_2.txt");
								list.setX();
								list.setY();
								setting("Level 2", sf::Vector2u(list.cols * 40, list.rows * 40));
								nivelActual = 2;
							...
							{
								list.deleteList();
								list.loadLevel("./assets/levels/level_3.txt");
								list.setX();
								list.setY();
								setting("Level 3", sf::Vector2u(list.cols * 40, list.rows * 40));
								nivelActual = 3;
							...
							{
								list.deleteList();
								list.loadLevel("./assets/levels/level_4.txt");
								list.setX();
								list.setY();
								setting("Level 4", sf::Vector2u(list.cols * 40, list.rows * 40));
								nivelActual = 4;
							...
							{
								list.deleteList();
								list.loadLevel("./assets/levels/level_5.txt");
								list.setX();
								list.setY();
								setting("Level 5", sf::Vector2u(list.cols * 40, list.rows * 40));
								nivelActual = 5;
...
void Window::menuRender()
{
	...
	case 1:
	{
		l_text.setFillColor(sf::Color::Cyan);
	...
	case 2:
	{
		e_text.setFillColor(sf::Color::Cyan);
		p_text.setFillColor(sf::Color::White);
		l_text.setFillColor(sf::Color::White);
		window.draw(m_sprite);
		window.draw(s_text);
...
void Window::replayRender()
{
	...
	case 0:
	{
		c_text.setFillColor(sf::Color::Cyan);
		r_text.setFillColor(sf::Color::White);
		rs_text.setFillColor(sf::Color::White);
		mm_text.setFillColor(sf::Color::White);
		e_text.setFillColor(sf::Color::White);
	...
	{
		c_text.setFillColor(sf::Color::White);
		r_text.setFillColor(sf::Color::Cyan);
		rs_text.setFillColor(sf::Color::White);
		mm_text.setFillColor(sf::Color::White);
		e_text.setFillColor(sf::Color::White);
	...
	case 2:
	{
		r_text.setFillColor(sf::Color::White);
		c_text.setFillColor(sf::Color::White);
		rs_text.setFillColor(sf::Color::Cyan);
		mm_text.setFillColor(sf::Color::White);
		e_text.setFillColor(sf::Color::White);
	...
	case 3:
	{
		...
		c_text.setFillColor(sf::Color::White);
		rs_text.setFillColor(sf::Color::White);
		mm_text.setFillColor(sf::Color::Cyan);
		e_text.setFillColor(sf::Color::White);
...
void Window::pauseRender()
{
	...
	case 3:
	{
		...
		c_text.setFillColor(sf::Color::White);
		mm_text.setFillColor(sf::Color::White);
		sv_text.setFillColor(sf::Color::Cyan);
		window.draw(m_sprite);
		window.draw(ps_text);
		window.draw(rs_text);
		window.draw(c_text);
